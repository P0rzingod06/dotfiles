...
*******************************************************************************
   ...
   BEGIN
      ...
      WWT_UPLOAD_GENERIC.LOG (0, 'ORIGINAL_FILE_NAME: ' || l_orig_file_name);
      WWT_UPLOAD_GENERIC.LOG (0, 'FILE_OWNER: ' || l_orig_file_owner);

      -- Creating Email DL based on orig filename from upload
      BEGIN
         WWT_UPLOAD_GENERIC.LOG (0, 'before distribution list update');
   ...
   BEGIN
      ...
      WWT_UPLOAD_GENERIC.LOG (0, 'After alert dist loading');


      FOR i IN c_load_data
      LOOP
         BEGIN
             WWT_UPLOAD_GENERIC.LOG (0, i.tbuy_so || 'inserted into table');
               ...
               SELECT *
                ...
                WHERE     tbuy_so = i.tbuy_so
                      ...
                      AND NVL (callout_line_number, 'NULL') =
                             ...
                             WWT_UPLOAD_GENERIC.LOG (0, i.tbuy_so || 'updated table');
